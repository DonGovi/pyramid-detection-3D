import torch
from utils import box_iou, box_nms, change_box_order, meshgrid, box_cover
...
class DataEncoder(object):
    ...
    def encode(self, boxes, labels, input_size):
        ...
        #print(boxes.size())
        cls_targets = box_cover(boxes, anchor_boxes, labels, order="zyxdhw")
        ...
        obj_ids = (cls_targets > 0)
        #print(obj_ids.long().sum())
        if obj_ids.long().sum() == 0:
...
if __name__ == '__main__':
    ...
    label_file = "E:/sph_samples/samples_64/samples_chosen.csv"
    ...
    for i in range(label_df.shape[0]):
        ...
        box_tensor, label_tensor = label.build_annotations()
